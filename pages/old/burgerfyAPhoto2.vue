<template>
    <main id='main'>
        ...
        <img id='userFileDisplay'>
        <button id='sliceImageButton' @click='sliceUpImage()'>Slice image</button>
  ...
  async asyncData({ $axios }) {
    ...
    methods: {
        onFileSelected(event) {
            ...
            this.findSelectedFileSource();
            // imageDisplay.src  = this.selectedFile.src;


        },
        findSelectedFileSource(){
            let image = document.getElementById("userFileDisplay");
            console.log("URL.createObjectURL(this.selectedFile))", URL.createObjectURL(this.selectedFile));
            ...
            img2.src = URL.createObjectURL(this.selectedFile);
            img2.style.height = 64;
            img2.style.width = 64;
            let initialCont = document.getElementById("initialCont");
            initialCont.appendChild(img2);
            this.img2 = img2;
            // img2
            // img2.onload = this.sliceUpImage;
        ...
        sliceUpImage(){
            ...
            console.log("this.image, this.img2", this.image, this.img2)
            let imageParts = [];
            for (let x = 0; x < 16; x++) {
                for (let y = 0; y < 16; y++) {
            ...
            console.log("imageParts, should be different",imageParts);
